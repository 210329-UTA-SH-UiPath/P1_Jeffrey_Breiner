...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ACrust :  IEquatable<ACrust>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ACrust);
        }

        /// <summary>
        /// Returns true if ACrust instances are equal
        /// </summary>
        /// <param name="input">Instance of ACrust to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ACrust input)
        {
            if (input == null)
                return false;
