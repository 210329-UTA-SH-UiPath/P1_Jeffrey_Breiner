...
namespace PizzaBox.Storing.Migrations
{
    ...
    [Migration("20210423134818_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PizzaBox.Storing.Entities.EntityModels.DBPlacedTopping", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PizzaBox.Storing.Entities.EntityModels.DBPlacedTopping", b =>
                {
                    b.HasOne("PizzaBox.Storing.Entities.EntityModels.DBPizza", "Pizza")
                        .WithMany("DBPlacedToppings")
                        .HasForeignKey("PizzaID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PizzaBox.Storing.Entities.EntityModels.DBTopping", "Topping")
                        .WithMany("DBPlacedToppings")
